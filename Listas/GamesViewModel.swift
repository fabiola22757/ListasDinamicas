...
struct GamesViewModel{
    ...
    func getGames() -> [Game] {
        ...
        var games: [Game] = [
            ...
            Game(id: 2, image: "meganium", name: "Meganium", console: "PS4", price: 130.00)
        ]
        
        //agregamos 500 registros más
        for x in 6 ... 200 {
                    games.append(Game(id: x, image: "toad", name: "Juego #\(x)", console: "PS4", price: (130.00 + Float(x) )))
                }
